...
// ID represents NeoFS API V2-compatible object identifier.
type ID struct {
	b []byte
}

// IDFromV2 reads ID from refs.ObjectID message.
func (x *ID) FromV2(id2 refs.ObjectID) {
	x.b = id2.GetValue()
}
...
//
// Returns an error if d is not a canonical ID string according to NeoFS API V2 spec.
...
// IDToV2 writes ID to refs.ObjectID message.
//
// Message must not be nil.
func IDToV2(idv2 *refs.ObjectID, id ID) {
