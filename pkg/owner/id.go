...
// ID represents NeoFS API V2-compatible account identifier.
type ID struct {
	b []byte
}

// FromV2 reads ID from refs.OwnerID message.
func (x *ID) FromV2(idv2 refs.OwnerID) {
	x.b = idv2.GetValue()
}
...
// IDToV2 writes ID to refs.OwnerID message.
//
// Message must not be nil.
func IDToV2(idv2 *refs.OwnerID, id ID) {
