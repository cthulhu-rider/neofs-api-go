...
func (x *DataAuditResult) Reset() {
	*x = DataAuditResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_v2_audit_grpc_types_proto_msgTypes[0]
...
var File_v2_audit_grpc_types_proto protoreflect.FileDescriptor

var file_v2_audit_grpc_types_proto_rawDesc = []byte{
	0x0a, 0x19, 0x76, 0x32, 0x2f, 0x61, 0x75, 0x64, 0x69, 0x74, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2f,
...
var (
	file_v2_audit_grpc_types_proto_rawDescOnce sync.Once
	file_v2_audit_grpc_types_proto_rawDescData = file_v2_audit_grpc_types_proto_rawDesc
)

func file_v2_audit_grpc_types_proto_rawDescGZIP() []byte {
	file_v2_audit_grpc_types_proto_rawDescOnce.Do(func() {
		file_v2_audit_grpc_types_proto_rawDescData = protoimpl.X.CompressGZIP(file_v2_audit_grpc_types_proto_rawDescData)
	})
...
func file_v2_audit_grpc_types_proto_init() {
	if File_v2_audit_grpc_types_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_v2_audit_grpc_types_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_v2_audit_grpc_types_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_v2_audit_grpc_types_proto_goTypes,
		DependencyIndexes: file_v2_audit_grpc_types_proto_depIdxs,
		MessageInfos:      file_v2_audit_grpc_types_proto_msgTypes,
	}.Build()
	File_v2_audit_grpc_types_proto = out.File
	file_v2_audit_grpc_types_proto_rawDesc = nil
	file_v2_audit_grpc_types_proto_goTypes = nil
	file_v2_audit_grpc_types_proto_depIdxs = nil
}
